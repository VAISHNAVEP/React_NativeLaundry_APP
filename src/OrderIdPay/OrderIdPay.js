  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <View style={style.totalContainer}>
        ...
        <Text style={[style.nos, style.alignText,{marginLeft:10}]}>3nos</Text>
        <Text style={style.number}>₹200</Text>
      </View>
      <View style={style.totalContainer}>
      ...
      <View>
        ...
        <View style={{flexDirection: 'row'}}>
          ...
          <TouchableOpacity
            style={[
              style.touch,
              {marginRight: 50, backgroundColor: colors.lightgreen},
            ]}>
            <Text style={[style.touchtext, {color: colors.primarygreen}]}>
              Pay
            </Text>
          </TouchableOpacity>
        </View>
